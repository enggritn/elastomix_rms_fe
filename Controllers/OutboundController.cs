    ...
    public class OutboundController : Controller
    {
        ...
        public async Task<ActionResult> ExportOutboundToExcel(string date, string enddate, string warehouse)
        {
            ...
            else
            {
                ...
                Uri uri = new Uri(ApiAddress + string.Format("Api/Outbound/GetDataReportOtherOutbound?date={0}&date={1}&warehouse={2}", date, enddate, warehouse));
                ...
                workSheet.Cells[1, 20].Value = "PutawayBag";
                workSheet.Cells[1, 21].Value = "PutawayFullBag";
                workSheet.Cells[1, 22].Value = "PutawayTotal";
                workSheet.Cells[1, 23].Value = "PutawayBinRack";
                workSheet.Cells[1, 24].Value = "PutawayBy";
                workSheet.Cells[1, 25].Value = "PutawayOn";
                workSheet.Cells[1, 26].Value = "Status";
                workSheet.Cells[1, 27].Value = "Memo";
                ...
                foreach (OutboundDetailReportDTO header in listdetail)
                {
                    ...
                    workSheet.Cells[recordIndex, 20].Value = header.PutawayBag;
                    workSheet.Cells[recordIndex, 21].Value = header.PutawayFullBag;
                    workSheet.Cells[recordIndex, 22].Value = header.PutawayTotal;
                    workSheet.Cells[recordIndex, 23].Value = header.PutawayBinRack;
                    ...
                    workSheet.Cells[recordIndex, 27].Value = header.Memo;
                    recordIndex++;
                }
