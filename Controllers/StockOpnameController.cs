    ...
    public class StockOpnameController : Controller
    {
        ...
        public async Task<ActionResult> ExportStockOpnameToExcel(string id)
        {
            ...
            else
            {
                ...
                String fileName = String.Format("filename=StockOpname_{0}.xlsx", date);
                ...
                workSheet.Cells[1, 1].Value = "Bin Rack Code";
                workSheet.Cells[1, 2].Value = "Material Code";
                workSheet.Cells[1, 3].Value = "Material Name";
                workSheet.Cells[1, 4].Value = "Lot No";
                workSheet.Cells[1, 5].Value = "In Date";
                workSheet.Cells[1, 6].Value = "Exp Date";
                workSheet.Cells[1, 7].Value = "Bag Qty";
                workSheet.Cells[1, 8].Value = "Qty Per Bag";
                workSheet.Cells[1, 9].Value = "Total Qty";
                workSheet.Cells[1, 10].Value = "Material Type";
                workSheet.Cells[1, 11].Value = "Scanned By";
                workSheet.Cells[1, 12].Value = "Scanned On";

                int recordIndex = 2;
                foreach (StockOpnameDetailDTO header in listdetail)
                {
                    workSheet.Cells[recordIndex, 1].Value = header.BinRackCode;
                    workSheet.Cells[recordIndex, 2].Value = header.MaterialCode;
                    workSheet.Cells[recordIndex, 3].Value = header.MaterialName;
                    workSheet.Cells[recordIndex, 4].Value = header.LotNo.Replace("`","");
                    ...
                    workSheet.Cells[recordIndex, 7].Value = header.BagQty;
                    workSheet.Cells[recordIndex, 8].Value = header.QtyPerBag;
                    workSheet.Cells[recordIndex, 9].Value = header.TotalQty;
                    workSheet.Cells[recordIndex, 10].Value = header.MaterialType;
                    workSheet.Cells[recordIndex, 11].Value = header.ScannedBy;
                    workSheet.Cells[recordIndex, 12].Value = header.ScannedOn;
                    workSheet.Cells[recordIndex, 12].Style.Numberformat.Format = "yyyy-MM-dd hh:mm:ss";
                    recordIndex++;
                }
